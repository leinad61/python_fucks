...
while running:
    ...
    knowledge_question1 = randomizerQ1 + randomizerW + fill_two + randomizerA + mark

    knowledge_bank_Q2 = question_starters[2:4]
    randomizerQ2 = random.choice(knowledge_bank_Q2)
    knowledge_question2 = randomizerQ2 + randomizerW + fill_one + randomizerA + mark

    knowledge_bank_Q3 = question_starters[5:7]
    way_of_knowing.remove(randomizerW)
    randomizerW3 = random.choice(way_of_knowing)
    way_of_knowing.append(randomizerW)
    randomizerQ3 = random.choice(knowledge_bank_Q3)
    knowledge_question3 = randomizerQ3 + randomizerW3 + fill_one + randomizerA + mark
    ...
    test = raw_input("Do you want to run again: ")
    no = ["NO", "No", "no", "N", "n"]
    if test in no:
        running = False
    elif test == "nO":
        print "Your retrad but..."
